...
Begin VB.Form Cplus 
   ...
   Begin VB.Image Image1 
      Height          =   9000
      Left            =   2040
      Picture         =   "Cplus.frx":2933
      Top             =   0
      Width           =   16500
   End
End
Attribute VB_Name = "Cplus"
...
book.Open "select * from CplusQues where sr_no = '" & Text1.Text & "'", connbook, adOpenKeyset, adLockReadOnly, adCmdText
