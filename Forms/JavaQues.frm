...
Begin VB.Form javaQues 
   Caption         =   "JAVA Language"
   ClientHeight    =   8985
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   16305
   ...
   Begin VB.Image Image1 
      Height          =   9000
      Left            =   1920
      Picture         =   "JavaQues.frx":2933
      Top             =   0
      Width           =   16500
   End
End
Attribute VB_Name = "javaQues"
...
book.Open "select * from JavaQues where sr_no = '" & Text1.Text & "'", connbook, adOpenKeyset, adLockReadOnly, adCmdText
