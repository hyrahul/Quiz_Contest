...
Begin VB.Form VBQues 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   Caption         =   "Visual Basic Language"
   ClientHeight    =   8985
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   16305
   ...
   Begin VB.Label Label3 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Visual Basic Question Page"
      BeginProperty Font 
         Name            =   "Segoe Print"
         Size            =   15.75
         Charset         =   0
   ...
   Begin VB.Image Image1 
      Height          =   9000
      Left            =   1920
      Picture         =   "VBQues.frx":2933
      Top             =   0
      Width           =   16500
   End
End
Attribute VB_Name = "VBQues"
...
book.Open "select * from VBQues where sr_no = '" & Text1.Text & "'", connbook, adOpenKeyset, adLockReadOnly, adCmdText
