...
Begin VB.Form CQues 
   ...
   Begin VB.Image Image1 
      Height          =   9000
      Left            =   1920
      Picture         =   "CQues.frx":2933
      Top             =   0
      Width           =   16500
   End
End
Attribute VB_Name = "CQues"
...
book.Open "select * from CQues where sr_no = '" & Text1.Text & "'", connbook, adOpenKeyset, adLockReadOnly, adCmdText
